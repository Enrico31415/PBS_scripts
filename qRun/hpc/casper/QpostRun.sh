...
#python3 /home/enrico.pierobon/tBot/send.py "Data Anal ${rl} started, creating tar"
...
#python3 /home/enrico.pierobon/tBot/send.py "Data Anal ${rl} tar completed, finish"
# faccio l'analisi

#ls -d "$PWD/"**/  |  xargs -i -n 1 -P 0 singularity exec ~/singulo/r3.6.3G.img Rscript /home/enrico.pierobon/singulo/RSc/rate2/anal.R {}

#python3 /home/enrico.pierobon/tBot/send.py "Data Anal ${rl} analisys completed, starting upload"
...
#python3 /home/enrico.pierobon/tBot/send.py "Data ${rl} analisys completed. END"
