...
#carico e tar
commandToRun="qsub -l select=1:ncpus=\"$i\":mem=64gb -N tarRun -v 'tarName=\"rateTEPC${nuclei}\", path=\"${outPath}\",rl=\"${labelIndex}\", gDriveFolder=\"TEPCOnly/casper/inner5mm${labelIndex}\"' -W depend=afterany${idConc} QpostRun.sh"
